...
require_relative './components/deponent_infinitivizer'
...
require_relative './components/deponent_participler'
require_relative './components/validator'
require_relative './components/imperatives_handler'
require_relative './components/deponent_imperatives_handler'
